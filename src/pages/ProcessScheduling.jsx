...
const ProcessScheduling = () => {
  ...
  const simulateFCFS = () => {
    ...
    sortedProcesses.forEach((process) => {
      ...
      newGanttChart.push({
        PID: process.PID,
        start: currentTime,
        end: currentTime + completionTime,
        turnaroundTime,
        waitingTime,
        finishTime: currentTime + completionTime,
      });
      ...
      if (readyQueue.length > 0) {
        ...
        if (parseInt(currentProcess.CompletionTime) > 0) {
          while (
            ...
            readyQueue.push(
              JSON.parse(JSON.stringify(remainingProcesses.shift()))
            );
          }
  ...
  const runPrioritySimulation = () => {
    ...
    // Create a copy of the processList to work with
    ...
    while (completedProcesses < processListCopy.length) {
      ...
      for (let i = 0; i < processListCopy.length; i++) {
        if (
          processListCopy[i].ArrivalTime <= currentTime &&
          processListCopy[i].CompletionTime > 0
        ) {
          if (processListCopy[i].Priority > highestPriority) {
          ...
          <div className="w-full my-2.5 grid grid-cols-1 gap-y-1 justify-items-center h-auto">
            ...
            <div className="ml-2 rounded w-[95%] border-black border-2 my-5 h-[250px] flex flex-row overflow-x-scroll">
              ...
              <div className="w-[91%] flex flex-col overflow-x-scroll">
                ...
                <div className="h-[30px] flex flex-row text-center">
                  {priorityActive ? renderPriorityGanttChart() : null}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-1/3 border-2 border-black rounded h-full my-2 mx-3 md:w-[98%] xs:w-[95%]">
          ...
          <div className="w-full flex flex-col">
            ...
            <div className="h-1/5 my-5 w-full">
              <p className="px-5 font-semibold">FCFS</p>
              <p className="px-2">
                Turnaround Time :{" "}
                {fcfsActive
            ...
            <div className="h-1/5">
              <p className="px-5 font-semibold">SJF</p>
              <p className="px-2">
                Turnaround Time :{" "}
                {sjfActive
            ...
            <div className="h-1/5 my-5">
              <p className="px-5 font-semibold">SRTF</p>
              <p className="px-2">
                Turnaround Time :{" "}
                {srtfActive
            ...
            <div className="h-1/5">
              <p className="px-5 font-semibold">ROUND ROBIN</p>
              <p className="px-2">
                Turnaround Time :{" "}
                {rrActive
            ...
            <div className=" h-1/5 my-5">
              <p className="px-5 font-semibold">PRIORITY BASED</p>
              <p className="px-2">
                Turnaround Time :{" "}
                {priorityActive
